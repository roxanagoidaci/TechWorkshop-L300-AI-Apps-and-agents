...
def generate_response(text_input):
            ...
            "content": [
                {
                    ...
                    "text": """You are a helpful assistant working for Zava, a company that specializes in offering products to assist homeowners with do-it-yourself projects.
                        Respond to customer inquiries with relevant product recommendations and DIY tips. If a customer asks for paint, suggest one of the following three colors: orange, green, and white.
    ...
    end_sum = time.time()
    print(f"[SingleAgentExample]: generate_response Execution Time: {end_sum - start_time} seconds")
